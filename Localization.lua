...
function MeleeUtils_BuildLocalization(context)
    local L = {};
    ...
    L["party"] = "Party";
    L["raid"] = "Raid";
    L["Report"] = "MeleeUtilsSVDrops-Report ";
    ...
    L["LDBClick"] = "Left-Click to open MeleeUtils|nRight-Click to open Blizzard-MeleeUtils";
    L["Help"] = "O = Show Options|n? = Show Help|nX = Close Frame|n|n- Mouseover a row to highlight and to show Item-Tooltip|n- Shift-Click to copy the ItemLink into the Chatframe-EditBox|n- Alt-Click to to edit the owner of selected Item(s)|n|nReport = Report current MeleeUtilsSVDrops|nReset = Reset the current MeleeUtilsSVDrops";
    L["tooltip"] = "Show Item-Tolltip";
    L["loaded-welcome"] = "type |cff00ff00/mu|r for options";
    ...
    L["dismissLootWindowOnEsc-tooltip"] = "Should dismiss MeleeUtils loot window when pressing ESC"
