...
mfpanel.ResumeSessionOnSwitch = CreateCheckButton("MeleeUtilsOptions_ResumeSessionOnSwitch", mfpanel, L["resumeSessionOnSwitch"])
mfpanel.ResumeSessionOnSwitch:SetPoint("TOPLEFT", mfpanel.AutoSwitchInstances, "TOPLEFT", 0, -25)
mfpanel.ResumeSessionOnSwitch:SetScript("OnClick", function(self) MeleeUtilsGlobalVars.resumeSessionOnSwitch = self:GetChecked() end)
mfpanel.ResumeSessionOnSwitch.tooltipText = L["resumeSessionOnSwitch-tooltip"]

mfpanel.PauseOnLogin = CreateCheckButton("MeleeUtilsOptions_PauseOnLogin", mfpanel, L["pauseOnLogin"])
mfpanel.PauseOnLogin:SetPoint("TOPLEFT", mfpanel.ResumeSessionOnSwitch, "TOPLEFT", 0, -25)
mfpanel.PauseOnLogin:SetScript("OnClick", function(self) MeleeUtilsGlobalVars.pauseOnLogin = self:GetChecked() end)

mfpanel.DismissLootWindowOnEsc = CreateCheckButton("MeleeUtilsOptions_DismissLootWindowOnEsc", mfpanel, L["dismissLootWindowOnEsc"])
mfpanel.DismissLootWindowOnEsc:SetPoint("TOPLEFT", mfpanel.PauseOnLogin, "TOPLEFT", 0, -25)
mfpanel.DismissLootWindowOnEsc:SetScript("OnClick", function(self) MeleeUtilsGlobalVars.dismissLootWindowOnEsc = self:GetChecked() end)
mfpanel.DismissLootWindowOnEsc.tooltipText = L["dismissLootWindowOnEsc-tooltip"]

mfpanel.ShowBlackLotusTimer = CreateCheckButton("MeleeUtilsOptions_ShowBlackLotusTimer", mfpanel, L["showBlackLotusTimer"])
mfpanel.ShowBlackLotusTimer:SetPoint("TOPLEFT", mfpanel.DismissLootWindowOnEsc, "TOPLEFT", 0, -25)
mfpanel.ShowBlackLotusTimer:SetScript("OnClick", function(self) MeleeUtilsGlobalVars.showBlackLotusTimer = self:GetChecked() end)
...
mfpanel.TrackHonor = CreateCheckButton("MeleeUtilsOptions_TrackHonor", mfpanel, L["Honor"])
...
mfpanel.TrackHKs = CreateCheckButton("MeleeUtilsOptions_TrackHKs", mfpanel, L["Honorable kills"])
...
mfpanel.TrackDKs = CreateCheckButton("MeleeUtilsOptions_TrackDKs", mfpanel, L["Dishonorable kills"])
...
mfpanel.TrackRanks = CreateCheckButton("MeleeUtilsOptions_TrackRanks", mfpanel, L["Ranks Kill Count"])
...
mfpanel.TrackXP = CreateCheckButton("MeleeUtilsOptions_TrackXP", mfpanel, L["Experience Gained"])
...
mfpanel.TrackSkill = CreateCheckButton("MeleeUtilsOptions_TrackSkill", mfpanel, L["Skill Level Increments"])
...
mfpanel.TrackRep = CreateCheckButton("MeleeUtilsOptions_TrackRep", mfpanel, L["Reputation Gained"])
...
mfpanel.TrackDeaths = CreateCheckButton("MeleeUtilsOptions_TrackDeaths", mfpanel, L["Deaths"])
...
mfpanel.TrackResets = CreateCheckButton("MeleeUtilsOptions_TrackResets", mfpanel, L["Instance Resets"])
...
mfpanel.TrackConsumes = CreateCheckButton("MeleeUtilsOptions_TrackConsumes", mfpanel, L["Consumes Used"])
...
mfpanel.TrackMoney = CreateCheckButton("MeleeUtilsOptions_TrackMoney", mfpanel, L["Money Gained"])
...
mfpanel.ShowHonorPercentOnTooltip = CreateCheckButton("MeleeUtilsOptions_ShowHonorPercentOnTooltip", mfpanel, L["showHonorPercentOnTooltip"])
mfpanel.ShowHonorPercentOnTooltip:SetPoint("TOPLEFT", mfpanel.AppearanceCategoryTitle, "TOPLEFT", 0, -25)
mfpanel.ShowHonorPercentOnTooltip:SetScript("OnClick", function(self) MeleeUtilsGlobalVars.showHonorPercentOnTooltip = self:GetChecked() end)

mfpanel.ShowHonorFrenzyCounter = CreateCheckButton("MeleeUtilsOptions_ShowHonorFrenzy", mfpanel, L["showHonorFrenzyCounter"])
mfpanel.ShowHonorFrenzyCounter:SetPoint("TOPLEFT", mfpanel.ShowHonorPercentOnTooltip, "TOPLEFT", 0, -25)
mfpanel.ShowHonorFrenzyCounter:SetScript("OnClick", function(self) MeleeUtilsGlobalVars.showHonorFrenzyCounter = self:GetChecked() end)

mfpanel.HonorDRinBGs = CreateCheckButton("MeleeUtilsOptions_HonorDRinBGs", mfpanel, L["honorDRinBGs"])
mfpanel.HonorDRinBGs:SetPoint("TOPLEFT", mfpanel.ShowHonorFrenzyCounter, "TOPLEFT", 0, -25)
mfpanel.HonorDRinBGs:SetScript("OnClick", function(self) MeleeUtilsGlobalVars.honorDRinBGs = self:GetChecked() end)

mfpanel.AutoResumeBGs = CreateCheckButton("MeleeUtilsOptions_AutoResumeBGs", mfpanel, L["autoResumeBGs"])
mfpanel.AutoResumeBGs:SetPoint("TOPLEFT", mfpanel.HonorDRinBGs, "TOPLEFT", 0, -25)
mfpanel.AutoResumeBGs:SetScript("OnClick", function(self) MeleeUtilsGlobalVars.autoResumeBGs = self:GetChecked() end)

mfpanel.MoveHonorFrenzyButton = CreateFrame("Button", "MeleeUtilsOptions_MoveHonorFrenzyButton", mfpanel, "MeleeUtilsPanelButtonTemplate")
...
mfpanel.MoveHonorFrenzyButton:SetScript("OnClick", function(self) MeleeUtils_HonorFrenzyMeter:Add(100, true) end)
...
mfpanel.ResetMinimapPositionButton = CreateFrame("Button", "MeleeUtilsOptions_ResetMinimapPositionButton", mfpanel, "MeleeUtilsPanelButtonTemplate")
...
mfpanel.ResetMinimapPositionButton:SetScript("OnClick", function(self) MeleeUtils_MinimapButton:ResetPosition() end)

mfpanel.ResetLootWindowPositionButton = CreateFrame("Button", "MeleeUtilsOptions_ResetLootWindowPositionButton", mfpanel, "MeleeUtilsPanelButtonTemplate")
...
mfpanel.ResetLootWindowPositionButton:SetScript("OnClick", function(self) MeleeUtils_MainWindow:ResetPosition() end)

mfpanel.ResetHUDPositionButton = CreateFrame("Button", "MeleeUtilsOptions_ResetHUDPositionButton", mfpanel, "MeleeUtilsPanelButtonTemplate")
...
mfpanel.ResetHUDPositionButton:SetScript("OnClick", function(self) MeleeUtils_HUD:ResetPosition() end)

mfpanel.ResetFontsButton = CreateFrame("Button", "MeleeUtilsOptions_ResetFontButton", mfpanel, "MeleeUtilsPanelButtonTemplate")
...
mfpanel.ResetFontsButton:SetScript("OnClick", function(self) MeleeUtils_MainWindow:ResetFont() end)
...
function InterfacePanel:AddonLoaded() 
	...
	InterfacePanel.MainFrame.DismissLootWindowOnEsc:SetChecked(MeleeUtilsGlobalVars.dismissLootWindowOnEsc)
	InterfacePanel.MainFrame.ShowBlackLotusTimer:SetChecked(MeleeUtilsGlobalVars.showBlackLotusTimer)
	InterfacePanel.MainFrame.ShowHonorPercentOnTooltip:SetChecked(MeleeUtilsGlobalVars.showHonorPercentOnTooltip)
	InterfacePanel.MainFrame.ShowHonorFrenzyCounter:SetChecked(MeleeUtilsGlobalVars.showHonorFrenzyCounter)
	InterfacePanel.MainFrame.PauseOnLogin:SetChecked(MeleeUtilsGlobalVars.pauseOnLogin)
	InterfacePanel.MainFrame.HonorDRinBGs:SetChecked(MeleeUtilsGlobalVars.honorDRinBGs)
	InterfacePanel.MainFrame.AutoResumeBGs:SetChecked(MeleeUtilsGlobalVars.autoResumeBGs)

	InterfacePanel.MainFrame.TrackLoot:SetChecked(MeleeUtilsGlobalVars.track.drops)
	InterfacePanel.MainFrame.TrackKills:SetChecked(MeleeUtilsGlobalVars.track.kills)
	InterfacePanel.MainFrame.TrackHonor:SetChecked(MeleeUtilsGlobalVars.track.honor)
	InterfacePanel.MainFrame.TrackHKs:SetChecked(MeleeUtilsGlobalVars.track.hks)
	InterfacePanel.MainFrame.TrackDKs:SetChecked(MeleeUtilsGlobalVars.track.dks)
	InterfacePanel.MainFrame.TrackRanks:SetChecked(MeleeUtilsGlobalVars.track.ranks)
	InterfacePanel.MainFrame.TrackConsumes:SetChecked(MeleeUtilsGlobalVars.track.consumes)
	InterfacePanel.MainFrame.TrackMoney:SetChecked(MeleeUtilsGlobalVars.track.money)
	InterfacePanel.MainFrame.TrackXP:SetChecked(MeleeUtilsGlobalVars.track.xp)
	InterfacePanel.MainFrame.TrackSkill:SetChecked(MeleeUtilsGlobalVars.track.skill)
	InterfacePanel.MainFrame.TrackRep:SetChecked(MeleeUtilsGlobalVars.track.rep)
	InterfacePanel.MainFrame.TrackDeaths:SetChecked(MeleeUtilsGlobalVars.track.deaths)
	InterfacePanel.MainFrame.TrackResets:SetChecked(MeleeUtilsGlobalVars.track.resets)
